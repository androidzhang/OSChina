...
public class SoftwareLib extends BaseActivity{
	...
	private List<SoftwareList.Software> lvSoftwareData = new ArrayList<SoftwareList.Software>();
    ...
    private void initSoftwareCatalogListView()
    {
    	...
    	mlvSoftwareCatalog.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {       		
        		...
        		SoftwareCatalogList.SoftwareType type = (SoftwareCatalogList.SoftwareType)name.getTag();
    ...
    private void initSoftwareListView()
    {
    	...
    	mlvSoftware.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    			...
    			SoftwareList.Software sw = (SoftwareList.Software)name.getTag();
				...
				if(msg.what >= 0){						
					...
					case UIHelper.LISTVIEW_ACTION_SCROLL:
						...
						if(lvSoftwareData.size() > 0){
							for(SoftwareList.Software sw1 : list.getSoftwarelist()){
								boolean b = false;
								for(SoftwareList.Software sw2 : lvSoftwareData){
