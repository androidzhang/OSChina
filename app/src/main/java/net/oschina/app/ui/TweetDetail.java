...
public class TweetDetail extends BaseActivity {
	...
	private void initView() {
		...
		mFootEditebox.setOnClickListener(new OnClickListener() {
		...
		mFootEditer.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				// 显示软键盘&隐藏表情
				showIMM();
			}
			...
			public void handleMessage(Message msg) {
				...
				if (msg.what == 1) {
					...
					if (faceURL.endsWith("portrait.gif")
						...
						userface.setImageResource(R.mipmap.widget_dface);
					} else {
	...
	// 表情控件点击事件
	private OnClickListener facesClickListener = new OnClickListener() {
		public void onClick(View v) {
			showOrHideIMM();
		}
	};
	...
	private OnClickListener commentpubClickListener = new OnClickListener() {
		public void onClick(View v) {
			_id = curId;
