...
import net.oschina.app.com.barcode.camera.CameraManager;
import net.oschina.app.com.barcode.decode.CaptureActivityHandler;
import net.oschina.app.com.barcode.decode.FinishListener;
import net.oschina.app.com.barcode.decode.InactivityTimer;
import net.oschina.app.com.barcode.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    private void setFlash() {
        if (flash.getTag() != null) {
            ...
            flash.setTag(null);
            flash.setBackgroundResource(R.mipmap.flash_open);
        } else {
            cameraManager.setTorch(false);
            flash.setTag("1");
            flash.setBackgroundResource(R.mipmap.flash_default);
        }
    }
