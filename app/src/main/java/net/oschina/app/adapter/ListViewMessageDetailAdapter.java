	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(msg.getAuthorId() == ac.getLoginUid())
		{
			if(faceURL.endsWith("portrait.gif") || StringUtils.isEmpty(faceURL)){
				listItemView.userface2.setImageResource(R.mipmap.widget_dface);
			}else{
			...
			listItemView.contentll.setBackgroundResource(R.mipmap.review_bg_right);
		}else{
			if(faceURL.endsWith("portrait.gif") || StringUtils.isEmpty(faceURL)){
				listItemView.userface1.setImageResource(R.mipmap.widget_dface);
			}else{
			...
			listItemView.contentll.setBackgroundResource(R.mipmap.review_bg_left);
		}
