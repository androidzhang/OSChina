...
public class ListViewSearchAdapter extends BaseAdapter {
	...
	private List<SearchList.Result> listItems;//数据集合
	 ...
	 * @param resource
	 */
	public ListViewSearchAdapter(Context context, List<SearchList.Result> data, int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		SearchList.Result res = listItems.get(position);
