...
public class ListViewSoftwareCatalogAdapter extends BaseAdapter {
	...
	private List<SoftwareCatalogList.SoftwareType> 			listItems;//数据集合
	 ...
	 * @param resource
	 */
	public ListViewSoftwareCatalogAdapter(Context context, List<SoftwareCatalogList.SoftwareType> data, int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		SoftwareCatalogList.SoftwareType softwareType = listItems.get(position);
