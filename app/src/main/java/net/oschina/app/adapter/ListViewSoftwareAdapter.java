...
public class ListViewSoftwareAdapter extends BaseAdapter {
	...
	private List<SoftwareList.Software> listItems;//数据集合
	 ...
	 * @param resource
	 */
	public ListViewSoftwareAdapter(Context context, List<SoftwareList.Software> data, int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		SoftwareList.Software software = listItems.get(position);
