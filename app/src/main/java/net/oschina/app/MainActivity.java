...
import net.oschina.app.widget.QuickActionGrid;
import net.oschina.app.widget.QuickActionWidget;
...
public class MainActivity extends BaseActivity {
    ...
    private void initQuickActionGrid() {
        ...
        mGrid.addQuickAction(new MyQuickAction(this, R.mipmap.ic_menu_myinfo,
                R.string.main_menu_myinfo));
        mGrid.addQuickAction(new MyQuickAction(this,
                R.mipmap.ic_menu_software, R.string.main_menu_software));
        mGrid.addQuickAction(new MyQuickAction(this, R.mipmap.ic_menu_sweep,
    ...
    private void initBadgeView() {
        ...
        bv_active.setBackgroundResource(R.mipmap.widget_count_bg);
