...
import net.oschina.app.com.weibo.net.AccessToken;
import net.oschina.app.com.weibo.net.DialogError;
import net.oschina.app.com.weibo.net.Weibo;
import net.oschina.app.com.weibo.net.WeiboDialogListener;
import net.oschina.app.com.weibo.net.WeiboException;
